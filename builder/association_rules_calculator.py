...
pwd=os.path.abspath(os.path.join(os.path.dirname('association_rules_calculator.py'),os.path.pardir))
sys.path.append(pwd)
...
def generate_transactions(data):
    ...
    for transaction_item in data:
        ...
        transactions[transaction_id].append(transaction_item["Course_or_Org_id"])
